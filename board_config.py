...
_DISPLAY_DC_PIN = 5  # data/command
_DISPLAY_DO_PIN = 6  # data out toward screen/MOSI
_DISPLAY_SCK_PIN = 8  # clock
_DISPLAY_CS_PIN = 9  # chip select
_DISPLAY_BL_PIN = 10  # backlight

_DISPLAY_DMA = 0
_DISPLAY_DMA_ABORT_ADDRESS = 0x50000000 + 0x464
